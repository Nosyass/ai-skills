...
> **Agent targets:** copilot, cursor, claude, chatgpt, codex
> **File name:** `SKILL.md` (inside `skills/loop-db-call/`)
> **Description:** Identify database access performed inside a loop (N+1 problem), explain the energy/perf impact, and propose a batched fix.

---

## Purpose

Identify database access performed inside a loop (N+1 problem), explain the energy/perf impact, and propose a batched fix.
...
- When the input contains: `jdbcTemplate.`
- When the input contains: `entityManager.find`
...
| Version | Date | Change |
|---|---|---|
| 0.1.1 | 2026-05-20 | Initial version |
